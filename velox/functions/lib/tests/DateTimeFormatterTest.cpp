...
TEST_F(JodaDateTimeFormatterTest, formatWeekYear) {
  ...
  auto formatter = builder.appendWeekYear(4)
    .setType(DateTimeFormatterType::JODA)
    .build();
  auto* timezone = date::locate_zone("GMT");
  const auto maxSize = formatter->maxResultSize(timezone);
  ...
  EXPECT_EQ(weekYear("2020-12-27 00:00:00"), "2021");
  EXPECT_EQ(weekYear("2021-12-25 00:00:00"), "2021");
  EXPECT_EQ(weekYear("2021-12-26 00:00:00"), "2022");
  EXPECT_EQ(weekYear("2022-01-01 00:00:00"), "2022");
  EXPECT_EQ(weekYear("2022-12-31 00:00:00"), "2022");
  EXPECT_EQ(weekYear("2023-01-01 00:00:00"), "2023");
  EXPECT_EQ(weekYear("2023-12-30 00:00:00"), "2023");
  EXPECT_EQ(weekYear("2023-12-31 00:00:00"), "2024");
}
