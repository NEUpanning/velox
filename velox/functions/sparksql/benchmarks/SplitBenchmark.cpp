...
class SplitBenchmark : public functions::test::FunctionBenchmarkBase {
 public:
  ...
  static const std::string kLegacySplitExpression;
...
const std::string SplitBenchmark::kLegacySplitExpression = "split_legacy(c0, '\\044')";
...
BENCHMARK(baseline, n) {
  benchmark->run(n, SplitBenchmark::kLegacySplitExpression);
}
